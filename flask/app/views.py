...
def get_recommendations():
    username = session['my_user']
    f_list = [1, 5, 8, 9, 13, 21, 30, 48, 50]
    final_list = rank.compute_article_ranking(f_list)
    articles = nl.view_articles(final_list)

    return render_template('recommend.html', artlist=articles, user_selected=username)
"""

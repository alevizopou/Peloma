...
cluster_topics_file = os.path.join(userhome, "PycharmProjects/flask/myweb/cluster_topics.txt")
article_topics_file = os.path.join(userhome, "PycharmProjects/flask/myweb/article_topics.txt")
group_topics_file = os.path.join(userhome, "PycharmProjects/flask/myweb/group_topics.txt")
group_lemmas_file = os.path.join(userhome, "PycharmProjects/flask/myweb/group_lemmas.txt")
# vocabulary_file = os.path.join(userhome, "PycharmProjects/flask/myweb/topic_vocabulary.txt")

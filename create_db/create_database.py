...
cursor.execute("LOAD DATA LOCAL INFILE '/home/afro/PycharmProjects/create_db/text/article_info.txt' "
               "INTO TABLE article LINES TERMINATED BY '\n'")

# categories
cursor.execute("LOAD DATA LOCAL INFILE '/home/afro/PycharmProjects/create_db/text/categories.txt' "
               "INTO TABLE category FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' (@col1) set category_name=@col1")

# article tag
cursor.execute("LOAD DATA LOCAL INFILE '/home/afro/PycharmProjects/create_db/text/article_tags.txt' "
...
cursor.execute("LOAD DATA LOCAL INFILE '/home/afro/PycharmProjects/create_db/text/article_text1.txt' "
...
cursor.execute("LOAD DATA LOCAL INFILE '/home/afro/PycharmProjects/create_db/text/article_text2.txt' "
               "INTO TABLE article_text "
               "LINES TERMINATED BY '***********************************************************************' (body)")
...
cursor.execute("LOAD DATA LOCAL INFILE '/home/afro/PycharmProjects/create_db/text/article_text3.txt' "
               "INTO TABLE article_text "
               "LINES TERMINATED BY '***********************************************************************' (body)")
...
cursor.execute("LOAD DATA LOCAL INFILE '/home/afro/PycharmProjects/create_db/text/article_text4.txt' "
               "INTO TABLE article_text "
               "LINES TERMINATED BY '***********************************************************************' (body)")

cursor.execute("ALTER TABLE article_text AUTO_INCREMENT=69")
# cursor.execute("ALTER TABLE article_text AUTO_INCREMENT=81")

# CATEGORIES FROM REUTERS (#5 SUGAR, #6 COFFEE, #7 HOUSING)
cursor.execute("LOAD DATA LOCAL INFILE '/home/afro/PycharmProjects/flask/myweb/reuters.txt' "
               "INTO TABLE article_text "
               "LINES TERMINATED BY '***********************************************************************' (body)")

cursor.execute("LOAD DATA LOCAL INFILE '/home/afro/PycharmProjects/create_db/text/users.txt' "
...
cursor.execute("LOAD DATA LOCAL INFILE '/home/afro/PycharmProjects/create_db/text/createhistory.txt' "

...
MODELS_DIR = os.path.join(userhome, "PycharmProjects/raw_process/gensim/models")
NUM_TOPICS = 1
TRUE_K = 3
...
class TextProcessor(object):
    ...
    def filter_tagger_output(self, taggerdestination, filtertaggerdestination):
        ...
        # print("Lemma dict:", lemma_dict)
        # k = list(lemma_dict.keys())
        # print("Lemmas:", len(lemma_dict))
        # return list(lemma_dict)
        return lemma_list
